...
function drawScore() {
    ...
    ctx.lineWidth = 3;
    ctx.strokeStyle = 'orange';
    ctx.strokeText("Skor: " + playerScore, 10, 30);
    ctx.fillStyle = 'black';
...
function drawBulletCount() {
    ...
    ctx.lineWidth = 3;
    ctx.strokeStyle = 'orange';
    ctx.strokeText("Mermi: " + gunMagazine, 500, 575);
    ctx.fillStyle = 'black';
    ctx.fillText("Mermi: " + gunMagazine, 500, 575);
    ctx.restore();
}
...
function gameOver(){
    ...
    ctx.strokeText("Skorun: " + playerScore, 100, 350);
    ctx.fillStyle = 'rgb(228, 168, 34)';
    ctx.fillText("Skorun: " + playerScore, 100, 350);
    ctx.restore();
